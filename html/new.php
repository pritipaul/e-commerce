<!doctype html>
            ...
            <section>
                <img src="../picture/Mickey-mouse.jpg" alt="this is the picture" class="ik" height="300px" width="300px">
                <h1>Your Order is Successfully placed</h1>
                <a href="./orderlist.php?name=<?php echo $name?> "><h3>Your Order List</h3></a>
