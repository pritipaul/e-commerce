...
$sql = "INSERT INTO `ecomars`.`caseon` (`name`, `add`, `email`, `ph`, `amount`, `Code`) VALUES ('$name', '$add', '$email','$ph', '$amount', '$code')";
...
<body>
    ...
    <img src="../picture/delivery.png" alt="this is the picture" id="pic" height="300px" width="300px">
    <div class="card m-5">
        <h5 class="card-header">Case On Delivery</h5>
        <div class="card-body">
            <form action="" method="POST" id="form">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="address" name="add" aria-describedby="emailHelp"
                        value="" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="ph" name="ph" aria-describedby="emailHelp" value=""
                        required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="Code" name="code" aria-describedby="emailHelp"
                        value="" required>
                </div>
