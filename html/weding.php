        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../picture/bannerwed.jpg" class="d-block w-100" alt="..." height="700px">
                </div>
                <div class="carousel-item">
                    <img src="../picture/bannerwed2.jpg" class="d-block w-100" alt="..." height="700px">
                </div>
                <div class="carousel-item">
                    <img src="../picture/banerwed3.jpg" class="d-block w-100" alt="..." height="700px">
                </div>
            </div>
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-1 g-3">
                ...
                <div class="col">
                    <div class="row row-cols-1 row-cols-md-3 g-4">
                        ...
                        <?php
                            include "./server.php";
                            $selectquery = "SELECT * FROM `ecomars` . `weding`";
                        ...
                        <div class="col">
                            <div class="card h-100">
                                ...
                                <div class="card-footer">
                                    <h5>Price - &#8377; 400</h5>
                                    <div class="btn-group">
                                        <a href="./buy.php?idj=<?php echo $row['idj'] ; ?>" class="btn btn-success">Buy Now</a>
