...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-md-7 py-4">
                        <h4 class="text-white">Saree</h4>
                        <p class="text-muted">A sari (sometimes also shari or spelled as saree) is a women's garment
                            from the Indian subcontinent that consists of an unstitched drape varying from 4.5 to 9
                            metres (15 to 30 feet) in length and 600 to 1,200 millimetres (24 to 47 inches) in breadth
                            that is typically wrapped around the waist, with one end draped over</p>
                    </div>
                    <div class="col-sm-4 offset-md-1 py-4">
                        <h4 class="text-white">Saree Collection</h4>
    ...
    <main>
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../picture/banner.jpg" class="d-block w-100" alt="..." height="700px">
                </div>
                <div class="carousel-item">
                    <img src="../picture/banner2.jpg" class="d-block w-100" alt="..." height="700px">
                </div>
                <div class="carousel-item">
                    <img src="../picture/banner1.png" class="d-block w-100" alt="..." height="700px">
                </div>
            </div>
        ...
        <!-------------------------------------------------------------------------------------------------------------->
        <div>
            <h1 class="head">Saree Collection</h1>
        </div>
        <main>
        <div class="div">
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-1 g-3">
                ...
                <div class="col">
                    <div class="row row-cols-1 row-cols-md-3 g-4">
                        ...
                        <?php
                            include "./server.php";
                            $selectquery = "SELECT * FROM `ecomars` . `saree`";
                        ...
                        <div class="col">
                            <div class="card h-100">
                                ...
                                <div class="card-footer">
                                    <h5>Price - &#8377; 400</h5>
                                    <div class="btn-group">
                                        <a href="./buy4.php?nol=<?php echo $row['nol'] ; ?>" class="btn btn-success">Buy Now</a>
